import { Directive, ElementRef, OnDestroy, effect, input, output } from '@angular/core';
...
export class VBackdropDirective implements OnDestroy {
  ...
  public readonly backdropZIndex = input<number>(999);
  ...
  private showBackdrop(): void {
    ...
    this.backdropElement.style.zIndex = this.backdropZIndex().toString();
