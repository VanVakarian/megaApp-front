...
const HARDWARE_SERVICE_DEFINITION: MetricsServiceDefinition = {
  ...
  groups: [
    ...
    },
    {
      id: 'disk',
      label: 'Disk',
      metrics: ['disk_free_bytes', 'disk_used_bytes', 'disk_free_ratio', 'disk_used_ratio', 'uptime_seconds'],
    },
    {
      id: 'process',
  ...
  metricColors: {
    ...
    disk_used_bytes: '#b45309',
    disk_free_ratio: '#fbbf24',
...
const METRIC_LABELS: Record<string, Record<string, string>> = {
  hardware: {
    ...
    disk_free_ratio: 'Disk Free Ratio',
